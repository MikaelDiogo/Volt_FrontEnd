  ...
  return (
    <form onSubmit={form.onSubmit(onSubmit)}>
      <Stack gap="sm">
        ...
        />
        <NumberInput label="Estoque mínimo" min={0} {...form.getInputProps("minStock")} />
        <NumberInput label="Preço de custo" min={0} decimalScale={2} prefix="R$ " {...form.getInputProps("costPrice")} />
        <NumberInput label="Preço de venda" min={0} decimalScale={2} prefix="R$ " {...form.getInputProps("salePrice")} />
